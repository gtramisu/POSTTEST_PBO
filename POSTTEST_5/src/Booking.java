public class Booking implements Transaksi {
    ...
    public Booking(String idBooking, String namaCustomer, String namaMUA, String tanggal, String catatan) {
        this(idBooking, namaCustomer, namaMUA, tanggal);
    ...
    public void prosesBooking() {
        System.out.println("Booking dengan ID " + idBooking + " sedang diproses yaa!");
    }

    @Override
    public void tampilRingkasan() {
        System.out.println("Booking: " + namaCustomer + " dengan " + namaMUA);
    }
}
...
public class Main {
    ...
    static void lihatBooking() {
        ...
        if (listBooking.isEmpty()) {
            ...
            for (Booking b : listBooking) {
                ...
                System.out.println("ID Booking : " + b.idBooking);
                System.out.println("Customer   : " + b.namaCustomer);
                System.out.println("MUA        : " + b.namaMUA);
                System.out.println("Tanggal    : " + b.tanggal);
                System.out.println("-----------------------------");
            }
    ...
    static void updateBooking() {
        ...
        b.namaCustomer = input.nextLine();

        System.out.print("Nama MUA baru: ");
        b.namaMUA = input.nextLine();
